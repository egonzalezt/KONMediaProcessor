...
public interface IAudioTranscodingProcessor
{
    ...
    string TranscodeAudio(string inputFilePath, string outputFilePath, AudioCodec audioEncoder = AudioCodec.AAC, int audioBitrate = 128, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    void ChangeAudioBitrate(string inputFilePath, string outputFilePath, int newBitrate, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    void ChangeAudioChannels(string inputFilePath, string outputFilePath, int channels, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    void ConcatenateAudios(string[] inputFilePaths, string outputFilePath, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    void ConvertAudioFormat(string inputFilePath, string outputFilePath, string format, bool overrideFile = false, CancellationToken cancellationToken = default);
}
