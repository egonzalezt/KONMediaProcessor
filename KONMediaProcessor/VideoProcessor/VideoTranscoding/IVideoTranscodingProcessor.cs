...
public interface IVideoTranscodingProcessor
{
    ...
    void TranscodeVideo(string inputFilePath, string outputFilePath, VideoCodec videoEncoder = VideoCodec.H264, AudioCodec audioEncoder = AudioCodec.AAC, int audioBitrate = 128, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    /// <param name="overrideFile">True to override the output file if it already exists, false otherwise (default is false).</param>
    /// <param name="cancellationToken">Cancellation token to stop the process</param>
    void ChangeVideoResolution(string inputFilePath, string outputFilePath, int newWidth, int newHeight, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    void SetVideoFrameRate(string inputFilePath, string outputFilePath, int frameRate, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    void ConcatenateVideos(string[] inputFilePaths, string outputFilePath, bool includeAudio = true, bool overrideFile = false, CancellationToken cancellationToken = default);
    ...
    /// <param name="overrideFile">True to override the output file if it already exists, false otherwise (default is false).</param>
    /// <param name="cancellationToken">Cancellation token to stop the process</param>
    void ChangeAspectRatio(string inputFilePath, string outputFilePath, AspectRatio aspectRatio, bool overrideFile = false, CancellationToken cancellationToken = default);
}