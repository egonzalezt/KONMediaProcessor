...
public class ImageTranscodingSamples
{
    ...
    public void CreateImage()
    {
        ...
        {
            new TextData { X = 0, Y = 0, Text = "Hello team!" },
            new TextData { X = 0, Y = 100, Text = "This is a test" },
            new TextData { X = 0, Y = 200, Text = "using facade" }
        };
        ...
        var width = 1000;
        var height = 300;
        var outputFilePath = Path.Combine(_outputPath, $"{Guid.NewGuid()}.jpg");
        var fontSize = 100;
    ...
    public void JoinImages()
    {
        ...
        var backgroundColor = "black";
        var outputFilePath = Path.Combine(_outputPath, $"{Guid.NewGuid()}.png");
    ...
    public void ImageToVideo()
    {
        ...
        var outputFilePath2 = Path.Combine(_outputPath, $"{Guid.NewGuid()}.mp4");
